...
//连接数据库
func init(){
	temDatabase,err:=sql.Open("mysql","bluesky:135246Cjw@tcp(rm-bp14fk5x3q4byb6a2so.mysql.rds.aliyuncs.com:3306)/final_exam_web_data?charset=utf8&parseTime=True&loc=Local")
